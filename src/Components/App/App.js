...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      playlistTracks: [{ name: 'playlistName1', artist: 'playslistArtist1', album: 'playlistAlbum1', id: 4 }, { name: 'playlistName2', artist: 'playslistArtist2', album: 'playlistAlbum2', id: 5 }, { name: 'playlistName3', artist: 'playslistArtist3', album: 'playlistAlbum3', id: 6 }]
    };
